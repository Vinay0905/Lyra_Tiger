# Product Requirements Document (PRD): Lyra Desktop Assistant (Kimi WebBridge Edition)
...
- **Dry Wit:** Playfully teasing when the user makes dramatic or poor coding choices, but never hostile or overbearing.
